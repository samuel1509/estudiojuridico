			...
			<div class="d-grid gap-2 d-md-flex justify-content-md-between opacity-75">
				...
				<div class="d-flex">
					<form
						class="d-flex"
						role="search"
						action="/estudiojuridico/controller/abogados/buscarAbogado.jsp"
						method="GET">
						<input
							type="hidden"
							id="filtro"
				...
				<table class="table text-center opacity-75">
					...
					<tbody>
						...
						if (usr != null && usr.getNombreRol().equals("admin")) {
							...
							out.println("<a href='#' data-bs-toggle='modal' data-bs-target='#updateModal " + "' idUpd='" + abogado.getId()
									+ "' nomUpd='" + abogado.getNombre() + "' apeUpd='" + abogado.getApellido() + "' emailUpd='"
									+ abogado.getEmail() + "' telUpd='" + abogado.getTel() + "' reseniaUpd='" + abogado.getResenia()
									+ "' idEspUpd='" + abogado.getEspecialidad().getId() + "'><i class='bi bi-pencil'></i></a>");

							out.println("<a href='#' data-bs-toggle='modal' data-bs-target='#deleteModal' idDel='" + abogado.getId()
					...
					<div class="modal-content">
						<div class="modal-header">
							<h1
								...
								id="exampleModalLabel">Agregar abogado</h1>
							<button
								type="button"
								class="btn-close"
								...
								<div class="mb-3 text-center">
									...
									<select
										...
										if (usr != null && usr.getNombreRol().equals("admin")) {
											...
											out.println("<option value=" + e.getId() + ">" + e.getEspecialidad() + "</option>");
												}
										}
										%>
									</select> 
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h1
								class="modal-title fs-5"
								id="exampleModalLabel">Eliminar abogado</h1>
							<button
								type="button"
								class="btn-close"
								data-bs-dismiss="modal"
						...
						<div class="modal-body">
							...
							<form
								...
								<div class="mb-3 text-center">
									<label
										for="recipient-name"
										class="col-form-label"> ¿Realmente desea eliminar el abogado?</label>
									<input
										type="text"
										class="form-control"
										readonly
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h1
								class="modal-title fs-5"
								id="exampleModalLabel">Modificar los datos del abogado</h1>
							<button
								type="button"
								class="btn-close"
								data-bs-dismiss="modal"
