...
<body>
	...
	<main class="container d-flex">
				...
				<div class="container-fluid mt-3">
					<div class="row g-3">
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								<img src="img/familiacard.jpeg" alt="familia"
									class="card-img-top">
								<div class="card-body">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								<img src="img/derecholaboral.jpg" alt="familia"
									class="card-img-top">
								<div class="card-body">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								<img src="img/administrativo2.jpg" alt="familia"
									class="card-img-top">
								<div class="card-body">
				...
				<div class="contenedor">
					...
					<div class="fila-equipo">
						...
						<div class="col-equipo">
							<img src="img/perfilnuevo.png" alt />
							<h3>Dra. Vanesa</h3>
							<p>Abogada graduada de la UNLP especializada en Derecho de
								Familia</p>
						</div>
						<div class="col-equipo">
						...
						<div class="col-equipo">
							<img src="img/perfil.jpg" alt />
							<h3>Dr. Pedro</h3>
							<p>Abogado graduado de la UNLP especializado en Derecho
								Administrativo</p>
		...
		<!-- redes-->
		<aside
			class="col-md-1 col-sm-12 d-flex flex-md-column flex-sm-row justify-content-center">

			<a class="link-dark text-center" href="https://www.facebook.com"
				target="_blank"> <i
				class="bi bi-facebook fs-3 mx-1 bg-dark-subtle rounded-circle"></i>
			</a> <a class="link-dark text-center" href="https://www.instagram.com"
				target="_blank"> <i
				class="bi bi-instagram fs-3 mx-1 bg-dark-subtle rounded-circle"></i></a>

			<a class="link-dark text-center" href="https://www.whatsapp.com"
				target="_blank"> <i
				class="bi bi-whatsapp fs-3 mx-1 bg-dark-subtle rounded-circle"></i></a>
		</aside>
	...
	<footer class="row row py-1 my-1">
		<div class="col d-flex align-items-center justify-content-center">
			<div class="fs-6 mb-3 text-alig">
				<a class="link-dark" class="link-dark"
					href="https://www.facebook.com" target="_blank"> <i
					class="bi bi-facebook fs-4 mx-1"></i></a> <a class="link-dark"
					href="https://www.instagram.com" target="_blank"> <i
					class="bi bi-instagram fs-4 mx-1"></i></a> <a class="link-dark"
					href="https://www.whatsapp.com" target="_blank"> <i
					class="bi bi-whatsapp fs-4 mx-1"></i></a> <span
					class="fst-italic text-dark"> Grupo: María Luján Acuña,
					Griselda Molina, Sandra Caseres Cano, Florencia Mammana, Cristian
					Aparicio - Comisión #23564 </span>
			</div>
		</div>
	</footer>
	<script
